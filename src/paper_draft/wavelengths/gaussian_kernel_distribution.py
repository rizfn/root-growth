...
from histogram import analyze_image, set_plot_style, style_axes
...
def main():
    ...
    out_png = output_dir / "wavelength_gaussian_kernel_tilted_vs_nontilted.png"
    plot_kernel_distribution(all_rows, out_png)

    print(f"\nTotal root estimates: {len(all_rows)}")
    print(f"Gaussian-kernel distribution saved to {out_png}")
